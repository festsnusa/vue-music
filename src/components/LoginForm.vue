<template lang="pug">
div(class="text-white text-center font-bold p-4 mb-4" v-if="login_show_alert" :class="login_alert_variant") {{ login_alert_msg }}
VeeForm(:validation-schema="loginSchema" @submit="login")
  ...
  button(type="submit" :disabled="login_in_submission"
    class="block w-full bg-purple-600 text-white py-1.5 px-3 rounded transition hover:bg-purple-700") Submit
</template>
